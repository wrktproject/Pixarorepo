/**
 * Export Worker
 * Handles full-resolution export processing in a separate thread
 */

import type { ExportTask, WorkerResponse } from '../types/worker';
import type { AdjustmentState } from '../types/adjustments';

// Worker message handler
self.onmessage = async (event: MessageEvent<ExportTask>) => {
